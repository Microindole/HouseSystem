...
# 应用的基础域名，用于支付宝回调等
APP_DOMAIN = "http://naafb728.natappfree.cc"
# APP_DOMAIN = "http://house.microindole.dpdns.org"
...
DEEPSEEK_API_KEY = "sk-037c4266658b4cac8df9362b3ea53b17"  # 这是你提供的密钥
